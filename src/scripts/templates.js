...
export function generateDamageLevelMinorTemplate() {
  return `
    <span class="story-detail__damage-level__minor" data-damage-level="minor">Story Rendah</span>
  `;
}

export function generateDamageLevelModerateTemplate() {
  return `
    <span class="story-detail__damage-level__moderate" data-damage-level="moderate">Story Sedang</span>
  `;
}

export function generateDamageLevelSevereTemplate() {
  return `
    <span class="story-detail__damage-level__severe" data-damage-level="severe">Story Berat</span>
  `;
}
  ...
  return `
    <div class="story-detail__header">
      ...
      <div class="story-detail__more-info">
        ...
        <div class="story-detail__more-info__inline">
          <div id="location-latitude" class="story-detail__location__latitude" data-value="${latitude}">Latitude:</div>
          <div id="location-longitude" class="story-detail__location__lon" data-value="${longitude}">Longitude:</div>
        </div>
